function openerp_pos_widgets(instance, module){ //module is instance.point_of_sale
    ...
    module.OrderWidget = module.PosBaseWidget.extend({
        ...
        update_summary: function(){
            var order = this.pos.get('selectedOrder');
            // var total_no_dis = order ? order.getTotalTaxIncludedNoDis() : 0;

            var total = order ? order.getTotalTaxIncluded() : 0;
            var taxes     = order ? total - order.getTotalTaxExcluded() : 0;
            
            order.set_price(total);
    ...
    module.PosWidget = module.PosBaseWidget.extend({
        ...
        show_error:function(error){
            ...
            new instance.web.Dialog(self, {
                title: error.title,
                buttons: [
                    {text: _t("Ok"), click: function(self) { $('.modal').modal('hide'); }}
                ]
            }, $('<div>').html(error.message)).open();
        },
        ...
        build_widgets: function() {
            ...
            // begin 20140715                
            this.validate_member_screen = new module.ValidateMemberScreenWidget(this,{});
            this.validate_member_screen.appendTo(this.$('.screens'));

            this.verify_member_id_screen = new module.VerifyMemberIdScreenWidget(this,{});
            this.verify_member_id_screen.appendTo(this.$('.screens'));        

            // weixin payment
            this.weixinnativepay_screen = new module.weixinNativePayScreenWidget(this,{});
            this.weixinnativepay_screen.appendTo(this.$('.screens'));   
            ...
            this.screen_selector = new module.ScreenSelector({
                ...
                screen_set:{
                    ...
                    // 20170719  验证会员
                    'validatemember':this.validate_member_screen,
                    'verifymemberid': this.verify_member_id_screen,
                    // weixin
                    'weixinnativepay':this.weixinnativepay_screen,
                },
                popup_set:{
